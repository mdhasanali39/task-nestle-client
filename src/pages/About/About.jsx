...
const About = () => {
  return (
    <div >
      ...
      >
        <div className="flex text-center w-full justify-center items-center">
          <div className="max-w-md">
            <h1 className="mb-5 text-5xl font-bold">Welcome to About page</h1>
      ...
      <div className="flex gap-6 flex-row-reverse my-20 px-20">
        ...
        <div className="about-container flex-1">
          ...
          <p>
            At [Your Company Name], we believe in simplicity and efficiency. Our
